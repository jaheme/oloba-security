...
public abstract class AbstractDbService {
    ...
    public void setSource(DataSource dataSource) {
    	...
    	namedJdbcTemplate = new NamedParameterJdbcTemplate(jdbc);
    }
...
//	}
    ...
    public <T> List<T> queryByNamed(String sql, Map<String,Object> parameters, final RowMapper<T> rowMapper) {
    ...
    public Double queryDouble(String sql, Object... value) {
        try {
        	Double d = jdbc.queryForObject(sql, value, Double.class);
            return d==null ? 0.0 : d;
        } catch(EmptyResultDataAccessException e) {
            return 0.0;
        }
